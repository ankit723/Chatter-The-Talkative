      ...
      <motion.div variants={slideIn('left', "tween", 0.2, 1)} className='flex-0.75 bg-black-100 p-8 rounded-2xl'>
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <textarea name='message' value={form.message} onChange={handleChange} placeholder='What do you want to say?' className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none border-none font-medium'/>
          </label>
